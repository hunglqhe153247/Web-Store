                        ...
                        <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                            <div class="more-info-tab clearfix ">
                                ...
                                <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                                    ...
                                    <li><a data-transition-type="backSlide" href="#smartphone" data-toggle="tab"><%= c.getName()%></a></li>
                                        <% } %>
                                        ...
                                        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                            ...
                                            <div class="item item-carousel">
                                                <div class="products">
                                                    <div class="product">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="detail.html"><img src="<%= p.getImagie()%>" height="200" width="200" alt=""></a> </div>
                                                            <!-- /.image -->
                                                        ...
                                                        <div class="cart clearfix animate-effect">
                                                            <div class="action">
                                                                <ul class="list-inline">
                                                                    ...
                                                                    <li class="lnk info"> <a data-toggle="tooltip" class="add-to-cart" href="detail.html" title="Infomation"> <i class="icon fa fa-info"></i> </a> </li>
